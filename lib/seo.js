...
export const DEFAULT_DESCRIPTION =
  "Letterly is your application command center for internships, co-ops, and early-career tech roles. Generate tailored materials, track applications, and prep for interviews from one resume.";
...
export const HOME_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Yes. Every generation is saved to your applications hub. Starter and Premium plans include unlimited history and pipeline tracking. Premium adds follow-up emails, thank-you notes, and interview prep for each saved application.",
  },
  {
